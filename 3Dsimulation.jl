...
nPerDim = 24                        # Number of points to generate for each coordinate.
...
initMethod = "ChebyshevNodes"       # Specify how to generate initial data points from "grid", "Gaussian", "uniform", or "ChebyshevNodes".
...
sampleSize = collect(50 : 10 : 200)
ntrial = 100                            # Repeat the sampling and regression for ntrial times and take the median error.
sampleMethods = ["bernoulli", "btPivotalCoordwise", "btPivotalPCA", "distPivotal"]
...
# Plot the results.
if target == "spring"
    title, name = "Spring3D | Chebyshev", "plot_spring3D_$initMethod" * "_$dpoly.png"
elseif target == "heat"
